...
- `.github/workflows/actualizar-bolsas.yml` — corre el script cada lunes 8:50am
  hora CDMX (10 min antes de la rutina) y hace commit del resultado. También se
  puede disparar a mano desde la pestaña Actions ("Run workflow").
